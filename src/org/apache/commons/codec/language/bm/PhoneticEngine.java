...
/*     */       
/* 109 */       for (Iterator i$ = this.phonemes.iterator(); i$.hasNext();) { left = (Rule.Phoneme)i$.next();
...
/* 209 */       List<Rule> rules = (List)this.finalRules.get(this.input.subSequence(this.i, this.i + patternLength));
/* 210 */       if (rules != null) {
...
/* 260 */     if (si.hasNext()) {
/* 261 */       sb.append((String)si.next());
/*     */     }
/* 263 */     while (si.hasNext()) {
/* 264 */       sb.append(sep).append((String)si.next());
/*     */     }
/*     */     
...
/* 364 */           Rule.Phoneme oldPhoneme = (Rule.Phoneme)phonemes.remove(newPhoneme);
...
/*     */     }
/*     */     
/* 373 */     return new PhonemeBuilder(phonemes.keySet(), null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */       }
/* 415 */       for (String l : (Set)NAME_PREFIXES.get(this.nameType))
/*     */       {
...
/*     */       }
/* 437 */       words2.removeAll((Collection)NAME_PREFIXES.get(this.nameType));
/* 438 */       break;
/*     */     case ASHKENAZI: 
/* 440 */       words2.addAll(words);
/* 441 */       words2.removeAll((Collection)NAME_PREFIXES.get(this.nameType));
/* 442 */       break;
/*     */     case GENERIC: 
...
/*     */     {
/* 455 */       input = (String)words.iterator().next();
/*     */     }
/*     */     else {
...
/* Location:              C:\Users\Admin\Dropbox\TOTP.jar!\org\apache\commons\codec\language\bm\PhoneticEngine.class
