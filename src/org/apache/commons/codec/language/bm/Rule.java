...
/*     */   
/* 209 */   private static final Map<NameType, Map<RuleType, Map<String, Map<String, List<Rule>>>>> RULES = new EnumMap(NameType.class);
/*     */   private final RPattern lContext;
/*     */   private final String pattern;
/*     */   
/* 213 */   static { for (NameType s : NameType.values()) {
...
/* 277 */       return false;
/*     */     }
/* 279 */     int i = input.length() - 1; for (int j = suffix.length() - 1; j >= 0; j--) {
...
/* 301 */     List<Rule> allRules = new ArrayList();
...
/*     */   {
/* 320 */     return getInstance(nameType, rt, Languages.LanguageSet.from(new HashSet(Arrays.asList(new String[] { lang }))));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 355 */     Map<String, List<Rule>> rules = (Map)((Map)((Map)RULES.get(nameType)).get(rt)).get(lang);
/*     */     
/* 357 */     if (rules == null) {
...
/* 373 */       Set<String> langs = new HashSet(Arrays.asList(in.split("[+]")));
/*     */       
...
/*     */       }
/*     */       
/* 387 */       List<Phoneme> phs = new ArrayList();
...
/* 473 */               List<Rule> rules = (List)lines.get(patternKey);
/* 474 */               if (rules == null) {
/* 475 */                 rules = new ArrayList();
...
/* 502 */     String content = regex.substring(startsWith ? 1 : 0, endsWith ? regex.length() - 1 : regex.length());
...
/*     */         {
/*     */           public boolean isMatch(CharSequence input) {
/* 520 */             return input.equals(this.val$content);
/*     */           }
/*     */         };
/*     */       }
...
/*     */         {
/*     */           public boolean isMatch(CharSequence input) {
/* 532 */             return Rule.startsWith(input, this.val$content);
/*     */           }
/*     */         }; }
/* 535 */       if (endsWith)
/*     */       {
...
/*     */         {
/*     */           public boolean isMatch(CharSequence input) {
/* 540 */             return Rule.endsWith(input, this.val$content);
/*     */           }
/*     */         };
/*     */       }
/*     */     } else {
...
/*     */           }
/* 556 */           String bContent = boxContent;
...
/*     */             {
/*     */               public boolean isMatch(CharSequence input) {
/* 564 */                 return (input.length() == 1) && (Rule.contains(this.val$bContent, input.charAt(0)) == shouldMatch);
/*     */               }
/*     */             }; }
/* 567 */           if (startsWith)
/*     */           {
...
/*     */             {
/*     */               public boolean isMatch(CharSequence input) {
/* 572 */                 return (input.length() > 0) && (Rule.contains(this.val$bContent, input.charAt(0)) == shouldMatch);
/*     */               }
/*     */             }; }
/* 575 */           if (endsWith)
/*     */           {
...
/*     */             {
/*     */               public boolean isMatch(CharSequence input) {
/* 580 */                 return (input.length() > 0) && (Rule.contains(this.val$bContent, input.charAt(input.length() - 1)) == shouldMatch);
/*     */               }
/*     */             };
/*     */           }
/*     */         }
...
/*     */ 
/* 589 */     new RPattern() {
/* 590 */       Pattern pattern = Pattern.compile(this.val$regex);
/*     */       
/*     */       public boolean isMatch(CharSequence input)
/*     */       {
...
/* Location:              C:\Users\Admin\Dropbox\TOTP.jar!\org\apache\commons\codec\language\bm\Rule.class
