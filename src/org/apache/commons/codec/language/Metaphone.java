...
/*     */ 
/*     */             }
/* 183 */             else if ((!isLastChar(wdsz, n)) && ("EIY".indexOf(local.charAt(n + 1)) >= 0))
/*     */             {
/* 185 */               code.append('S');
/*     */ 
/*     */             }
/* 188 */             else if ((isPreviousChar(local, n, 'S')) && (isNextChar(local, n, 'H')))
/*     */             {
/* 190 */               code.append('K');
/*     */ 
/*     */             }
/* 193 */             else if (isNextChar(local, n, 'H')) {
...
/*     */ 
/*     */           }
/* 298 */           else if (!regionMatch(local, n, "TCH"))
/*     */           {
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Admin\Dropbox\TOTP.jar!\org\apache\commons\codec\language\Metaphone.class
